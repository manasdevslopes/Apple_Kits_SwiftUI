...
struct Book: Identifiable, Equatable {
  ...
  static var examples: [Book] = [
    ...
    Book(id: UUID(), title: "Charlotte's Web", author: Author.examples[5], category: .children, price: 10.99, inventoryCount: 85),
    ...
    Book(id: UUID(), title: "The Grapes of Wrath", author: Author.examples[6], category: .fiction, price: 19.99, inventoryCount: 100),
    Book(id: UUID(), title: "Harry Potter and the Sorcerer's Stone", author: Author.examples[0], category: .fiction, price: 14.99, inventoryCount: 65),
